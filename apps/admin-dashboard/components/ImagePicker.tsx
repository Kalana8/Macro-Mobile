  ...
  return (
    <div>
      <div className="flex gap-2">
        <label className="flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-[10px] border border-dashed border-border bg-bg px-3 py-2.5 text-[12.5px] font-semibold text-primary">
          📷 Take Photo
          <input
            type="file"
            accept="image/*"
